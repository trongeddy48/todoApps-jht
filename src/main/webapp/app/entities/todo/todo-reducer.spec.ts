...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './todo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TODO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TODO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TODO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TODO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TODO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TODO actions', async () => {
      const expectedActions = [
        {
